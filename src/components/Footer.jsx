...
const Footer = () => {
  return (
    <div>
      <div className="bg-blue-600 mt-5">
        <footer className="footer p-10 max-w-7xl mx-auto text-white text-lg">
          <nav>
          ...
          <form>
            ...
            <fieldset className="form-control lg:w-80">
              ...
              <div className="join">
                ...
                />
                <button className="btn bg-lime-500 hover:bg-lime-600 text-white border-0 join-item">
                  Subscribe
                </button>
              </div>
            </fieldset>
      ...
      <div className="bg-blue-600">
        <footer className="footer px-10 py-4 border-t text-white max-w-7xl mx-auto">
